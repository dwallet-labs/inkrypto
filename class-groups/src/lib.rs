...
pub(crate) use ibqf::accelerator;
...
/// The size of the class group is bounded from above by $log_2{\delta}\2 + log_2{log_2{\delta}}$ by the class number formula.
...
pub const DECRYPTION_KEY_BITS_112BIT_SECURITY: u32 =
    MINIMUM_FUNDAMENTAL_DISCRIMINANT_112BIT_SECURITY_BITS / 2
        + StatisticalSecuritySizedNumber::BITS
        + MINIMUM_FUNDAMENTAL_DISCRIMINANT_112BIT_SECURITY_BITS.ilog2()
        + 1;

pub const DECRYPTION_KEY_BITS_128BIT_SECURITY: u32 =
    MINIMUM_FUNDAMENTAL_DISCRIMINANT_128BIT_SECURITY_BITS / 2
        + StatisticalSecuritySizedNumber::BITS
        + MINIMUM_FUNDAMENTAL_DISCRIMINANT_128BIT_SECURITY_BITS.ilog2()
        + 1;

...
use crypto_bigint::{ConstChoice, Int, Limb, Uint};
...
#[cfg(test)]
mod tests {
    use crypto_bigint::{ConstChoice, I128};

    use crate::helpers::extension::{ExtendedInt, ExtendedUint};
    use crate::{Uint, U64};
    ...
    #[test]
    fn wrapping_neg() {
        let zero = ExtendedInt::from_product(I128::ZERO, U64::ZERO);
        assert_eq!(zero, zero.wrapping_neg_if(ConstChoice::FALSE));
        assert_eq!(zero, zero.wrapping_neg_if(ConstChoice::TRUE));
    }
}

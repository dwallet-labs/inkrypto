...
//! This file implements the `Presign` protocol trait for Class Groups

use crypto_bigint::{ConcatMixed, Encoding, Int, Uint};

use crate::class_groups::asynchronous::Protocol;
use crate::class_groups::{Presign, PresignAsyncParty};
    ...
    Uint<MESSAGE_LIMBS>: Encoding,
{
    ...
    type PresignParty = PresignAsyncParty<
        SCALAR_LIMBS,
        FUNDAMENTAL_DISCRIMINANT_LIMBS,
        NON_FUNDAMENTAL_DISCRIMINANT_LIMBS,
        MESSAGE_LIMBS,

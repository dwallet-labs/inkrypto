    ...
    Uint<MESSAGE_LIMBS>: Encoding,
{
    pub fn evaluate_encryption_of_partial_signature_prehash_class_groups(
        ...
        centralized_party_dkg_public_output: dkg::centralized_party::VersionedOutput<
            SCALAR_LIMBS,
            GroupElement::Value,
        >,
        ...
        >,
    > {
        let centralized_party_dkg_public_output =
            dkg::centralized_party::Output::from(centralized_party_dkg_public_output);

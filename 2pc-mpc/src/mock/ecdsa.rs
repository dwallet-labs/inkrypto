    ...
    >: mpc::Party,
{
    ...
    type Message = <RealPresignAsyncECDSAParty<
        SCALAR_LIMBS,
        FUNDAMENTAL_DISCRIMINANT_LIMBS,
        NON_FUNDAMENTAL_DISCRIMINANT_LIMBS,
        MESSAGE_LIMBS,
    ...
    >,
{
    ...
    > {
        ...
        .value();
        // Reuse a stored ciphertext as the dummy ciphertext (never read — the mocked sign uses the
        // constant nonce and ignores the presign).
        ...
        Ok(AsynchronousRoundResult::Finalize {
            ...
            private_output: (),
            public_output: vec![crate::ecdsa::presign::VersionedPresign::TargetedPresign(presign)],
        })
    }
    ...
    >: mpc::Party,
{
    ...
    type PublicOutputValue = <RealSignDecentralizedECDSAParty<
        ...
        GroupElement,
    > as mpc::Party>::PublicOutputValue;
    type Message = <RealSignDecentralizedECDSAParty<
        SCALAR_LIMBS,
        FUNDAMENTAL_DISCRIMINANT_LIMBS,
        NON_FUNDAMENTAL_DISCRIMINANT_LIMBS,
        MESSAGE_LIMBS,
    ...
    >: mpc::Party,
{
    ...
    type PublicOutputValue = <RealDKGSignDecentralizedECDSAParty<
        ...
        GroupElement,
    > as mpc::Party>::PublicOutputValue;
    type Message = <RealDKGSignDecentralizedECDSAParty<
        SCALAR_LIMBS,
        FUNDAMENTAL_DISCRIMINANT_LIMBS,
        NON_FUNDAMENTAL_DISCRIMINANT_LIMBS,
        MESSAGE_LIMBS,

...
pub(crate) mod tests {
        ...
        >,
    {
        ...
        // Print one column per round that actually ran — under `unsafe_mock` the party simulates
        // the real protocol's round structure, finalizing on the same final round.

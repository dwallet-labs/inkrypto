...
pub struct Party {}
/// INSECURE `unsafe_mock`: the real multi-round, multi-CRT-prime backward-compatible (V2) network DKG
/// party is replaced by an instant mock that finalizes with the `core` of the canonical
/// `NETWORK_KEY_SEED` output.
#[cfg(feature = "unsafe_mock")]
pub use crate::mock::network_dkg::MockNetworkDKGPartyV2 as Party;

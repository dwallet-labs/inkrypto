...
use crate::decentralized_party_backward_compatible::reconfiguration::{Message, PublicOutput};
...
impl super::Party {
    ...
    pub(crate) fn compute_encryption_key(
        ...
        let masked_decryption_key_commitment = public_verification_key_base
            .scale_integer_vartime(&masked_decryption_key, equivalence_class_public_parameters);

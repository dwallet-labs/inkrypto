...
>(
    ...
    exponents: Vec<(Uint<EXP_LIMBS>, u32)>,
    residue_params: MontyParams<LIMBS>,
    ...
    let batched_columns: Vec<MontyForm<LIMBS>> = (0..number_of_columns)
        .map(|i| {
            ...
            let batched_column = MontyForm::multi_exponentiate_bounded_exp(
...
mod tests {
    ...
    fn verifies() {
        ...
        let residue_params = MontyParams::new(Odd::new(n).unwrap());
        let g = MontyForm::new(&generator, residue_params);

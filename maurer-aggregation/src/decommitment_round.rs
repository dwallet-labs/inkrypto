...
use proof_aggregation::synchronous::{process_incoming_messages, DecommitmentRoundParty};

use crate::proof_share_round;
use crate::{Error, Result};

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq, Eq)]
pub struct Decommitment<const REPETITIONS: usize, Language: maurer::Language<REPETITIONS>> {

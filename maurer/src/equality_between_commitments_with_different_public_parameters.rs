...
use group::{direct_product, self_product, Samplable, Transcribeable};
...
/// The Canonical Representation of the Public Parameters of the Equality Between Two Commitments With Different Public Parameters
/// Maurer Language.
#[derive(Serialize)]
...
> {
    canonical_groups_public_parameters: CanonicalGroupsPublicParameters<
        ...
        self_product::PublicParameters<2, CommitmentSpacePublicParameters>,
    >,
    canonical_first_commitment_scheme_public_parameters:
        CommitmentSchemePublicParameters::CanonicalRepresentation,
    canonical_second_commitment_scheme_public_parameters:
        CommitmentSchemePublicParameters::CanonicalRepresentation,
}
    ...
    >
{
    fn from(
        ...
        Self {
            ...
            canonical_first_commitment_scheme_public_parameters: value
                .first_commitment_scheme_public_parameters
                .into(),
            canonical_second_commitment_scheme_public_parameters: value
                .second_commitment_scheme_public_parameters
                .into(),
        }
    }
...
pub mod test_helpers {
    ...
    pub type Lang<const BATCH_SIZE: usize> = Language<
    ...
    pub fn language_public_parameters<const BATCH_SIZE: usize>(
...
mod tests {
    ...
    fn valid_proofs_verifies_batch(#[case] number_of_proofs: usize, #[case] batch_size: usize) {
        ...
        let (proofs, statements): (
            Vec<crate::Proof<SOUND_PROOFS_REPETITIONS, Lang<1>, _>>,
            Vec<Vec<StatementSpaceGroupElement<SOUND_PROOFS_REPETITIONS, Lang<1>>>>,
        ) = iter::repeat_with(|| {
            let witnesses = sample_witnesses::<SOUND_PROOFS_REPETITIONS, Lang<1>>(
                &language_public_parameters,
                batch_size,
                &mut OsCsRng,
            );
...
pub(crate) mod benches {
    ...
    use crate::{
        equality_between_commitments_with_different_public_parameters::test_helpers::{
